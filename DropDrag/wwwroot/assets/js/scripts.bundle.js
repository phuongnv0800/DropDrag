...
var KTDrawer = function (e, t)
{
	...
	if (null != e)
	{
		var r = {
			...
			{
				n.options = KTUtil.deepExtend(
				{}, r, t), n.uid = KTUtil.getUniqueId("drawer"), n.element = e, n.overlayElement = null, n.name = n.element.getAttribute("data-kt-drawer-name"), n.shown = !1, n.lastWidth, n.toggleElement = null, n.element.setAttribute("data-kt-drawer", "true"), a(), d(), KTUtil.data(n.element).set("drawer", n)
			},
			a = function ()
			{
				var e = f("toggle"),
...
var KTFeedback = function (e)
{
	var t = this,
		...
		r = function ()
		{
			...
			{}, i, e), t.uid = KTUtil.getUniqueId("feedback"), t.element, t.shown = !1, o(), KTUtil.data(t.element).set("feedback", t)
		},
		o = function ()
		{
...
var KTMenu = function (e, t)
{
	...
	if (null != e)
	{
		var i = {
			...
			{
				n.options = KTUtil.deepExtend(
				{}, i, t), n.uid = KTUtil.getUniqueId("menu"), n.element = e, n.triggerElement, n.element.setAttribute("data-kt-menu", "true"), d(), u(), KTUtil.data(n.element).set("menu", n)
			},
			o = function (e)
			{
...
var KTScroll = function (e, t)
{
	...
	if (e)
	{
		var i = {
			...
			{
				n.options = KTUtil.deepExtend(
				{}, i, t), n.element = e, n.id = n.element.getAttribute("id"), n.element.setAttribute("data-kt-scroll", "true"), a(), KTUtil.data(n.element).set("scroll", n)
			},
			o = function ()
			{
...
var KTScrolltop = function (e, t)
{
	...
	if (null != e)
	{
		var r = {
			...
			{
				n.options = KTUtil.deepExtend(
				{}, r, t), n.uid = KTUtil.getUniqueId("scrolltop"), n.element = e, n.element.setAttribute("data-kt-scrolltop", "true"), a(), KTUtil.data(n.element).set("scrolltop", n)
			},
			a = function ()
			{
	...
	if (null != e)
	{
		var r = {
			...
			o = function ()
			{
				...
				{}, r, t), n.uid = KTUtil.getUniqueId("sticky"), n.name = n.element.getAttribute("data-kt-sticky-name"), n.attributeName = "data-kt-sticky-" + n.name, n.eventTriggerState = !0, n.lastScrollTop = 0, n.scrollHandler, n.element.setAttribute("data-kt-sticky", "true"), window.addEventListener("scroll", a), a(), KTUtil.data(n.element).set("sticky", n)
			},
			a = function (e)
			{
				var t, r, o = u("offset"),
...
var KTUtil = function ()
{
	var e = [],
		t = function ()
		{
			window.addEventListener("resize", (function ()
			{
				//throttle dùng để giới hạn thời gian cho phép gọi 1 lẫn mỗi 200ms
				KTUtil.throttle(undefined, (function ()
				{
					! function ()
					{
	...
	return {
		...
		resize: function ()
		{
			//Nếu "function" là một sự kiện do coder tự định nghĩa, 
			//hàm dispathEvent cho phép chạy sự kiện mới tên là resize
			if ("function" == typeof Event) window.dispatchEvent(new Event("resize"));
			//Ngược lại tạo UIEvent
			else
			{
